  ...
  head: () => ({
    meta: [
      ...
      { title: "K&P Love — Always Together" },
      {
        name: "description",
        content:
          "A private world for two: shared location, chat, memories, love notes and countdowns.",
      },
      { name: "author", content: "K&P Love" },
      { name: "theme-color", content: "#EC407A" },
      { property: "og:title", content: "K&P Love — Always Together" },
      { property: "og:description", content: "A private world for two." },
